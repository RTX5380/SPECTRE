...
void readMemoryByte(size_t malicious_x, uint8_t value[2], int score[2])
{
    ...
    {
        // Shuffle the index array for cache line flushing
...
void calculate_success_rate_and_exit() {
    ...
    double bandwidth = (double)success_count / 180; // Estimate bandwidth
...
int main(int argc, const char* * argv)
{
    ...
    alarm(180); // Set an alarm to stop the program after 180 seconds
